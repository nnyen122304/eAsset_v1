...
@Component({
  selector: 'app-ap-license-ap-get-tan-search',
  templateUrl: './ap-license-ap-get-tan-search.component.html',
  styleUrls: ['./ap-license-ap-get-tan-search.component.scss']
})
export class ApLicenseApGetTanSearchComponent extends AbstractChildComponent<ApLicenseComponent> implements OnInit {
   ...
   */
  back() {
    this.parent.changeChild(this.parent.viewIndexApLicenseMain, {action: 'backFromLine', params: {}});
  }
}

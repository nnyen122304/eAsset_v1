...
@Component({
  selector: 'app-ap-end-tan',
  templateUrl: './ap-end-tan.component.html',
  styleUrls: ['./ap-end-tan.component.scss']
})
export class ApEndTanComponent extends AbstractMainComponent implements OnInit {

...
@Component({
  selector: 'app-license-report-upgrade',
  templateUrl: './license-report-upgrade.component.html',
  styleUrls: ['./license-report-upgrade.component.scss']
})
export class LicenseReportUpgradeComponent extends AbstractChildComponent<LicenseReportComponent> implements OnInit {
  /**
   * セッション情報
   */
  ...
  downloadCSV() {
    ...
    if (this.searchParamSC !== null) {
      this.licenseService.createUpgradeCsv(this.loginStaffCode, this.accessLevel, this.searchParamSC).subscribe(

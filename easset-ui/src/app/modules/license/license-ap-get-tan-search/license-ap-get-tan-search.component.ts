...
@Component({
  selector: 'app-license-ap-get-tan-search',
  templateUrl: './license-ap-get-tan-search.component.html',
  styleUrls: ['./license-ap-get-tan-search.component.scss']
})
export class LicenseApGetTanSearchComponent extends AbstractChildComponent<LicenseComponent> implements OnInit {
   ...
   */
  back() {
    this.parent.changeChild(this.parent.viewIndexLicenseMain, {action: 'backFromLine', params: {}});
  }
}

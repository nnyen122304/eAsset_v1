/**
 * ApLicenseServiceSoapBindingStub.java
 *
...
public class ApLicenseServiceSoapBindingStub extends org.apache.axis.client.Stub implements jp.co.ctcg.easset.ws.ApLicenseService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://ws.easset.ctcg.co.jp", "acceptRouteAuthDisp"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://ws.easset.ctcg.co.jp", "acceptRouteChargeDisp"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://ws.easset.ctcg.co.jp", "acceptRouteDispType"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
    ...
    public ApLicenseServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ApLicenseServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ApLicenseServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {applicationId, applicationType, companyCode, apSectionCode, apCreateStaffCode, apStaffCode, apTel, apTitle, apSubTitle, apListTitle, eAssetUrl, acceptRouteAuthDisp, acceptRouteChargeDisp, acceptRouteDispType});

...
@ToString
public class ApEndRe implements Externalizable {
	...
	private String apStatus; // 申請書ステータス 1:未申請,2:申請中,3:承認済,4:差戻し,5:却下,6:取下げ 汎用マスタ-AP_STATUS_END_RE
	private Date apDate; // 申請日
	private String apEndReType; // 申請区分 1:再レンタル/返却,2:中途解約　汎用マスタ-AP_END_RE_TYPE
	private String apEndReAmountRange; // 金額範囲 汎用マスタ-AP_END_RE_AMOUNT_RANGE
	...
	private String leCompanyCode; // レンタル会社 MI顧客マスタコード
	...
	private Long totalAmount; // 申請金額 再レンタル:再レンタル金額合計,中途解約:残レンタル料合計
	private Long totalReAmount; // 再レンタル金額合計
	private Long totalPurchaseAmount; // 買取金額合計
	private Long totalRemainAmount; // 残レンタル料合計
	...
	private String reFlag; // 再レンタルフラグ 0:再レンタル物件無,1:再レンタル物件有
	...
	private String apEndReTypeName;	//	申請区分名
	private String apEndReAmountRangeName;	//	金額範囲名
	...
	private String leCompanyName; // レンタル会社名
	...
	//	明細
	List<ApEndReLineLld> apEndReLineLldList;	// 物件明細
	List<ApEndReLineAst> apEndReLineAstList;	// 資産(機器)明細
	List<ApEndReLineLic> apEndReLineLicList;	// ライセンス明細
	List<ApEndReLineLld> apEndReLineOtherLldList;	// 同一契約他物件明細
	List<ApEndReLineAtt> apEndReLineAttList;	// 添付明細
	...
	public void readExternal(ObjectInput input) throws IOException, ClassNotFoundException {
		...
		apEndReType = (String)input.readObject();
		apEndReAmountRange = (String)input.readObject();
		...
		apEndReTypeName = (String)input.readObject();
		apEndReAmountRangeName = (String)input.readObject();
		...
		//	明細
		apEndReLineLldList = (List<ApEndReLineLld>)input.readObject();
		apEndReLineAstList = (List<ApEndReLineAst>)input.readObject();
		apEndReLineLicList = (List<ApEndReLineLic>)input.readObject();
		apEndReLineOtherLldList = (List<ApEndReLineLld>)input.readObject();
		apEndReLineAttList = (List<ApEndReLineAtt>)input.readObject();
	}
	...
	public void writeExternal(ObjectOutput output) throws IOException {
		...
		output.writeObject(apEndReType);
		output.writeObject(apEndReAmountRange);
		...
		output.writeObject(apEndReTypeName);
		output.writeObject(apEndReAmountRangeName);
		...
		//	明細
		output.writeObject(apEndReLineLldList);
		output.writeObject(apEndReLineAstList);
		output.writeObject(apEndReLineLicList);
		output.writeObject(apEndReLineOtherLldList);
		output.writeObject(apEndReLineAttList);
	}
	...
	public String getApEndReType() {
		return apEndReType;
	}

	public void setApEndReType(String apEndReType) {
		this.apEndReType = apEndReType;
	}

	public String getApEndReAmountRange() {
		return apEndReAmountRange;
	}

	public void setApEndReAmountRange(String apEndReAmountRange) {
		this.apEndReAmountRange = apEndReAmountRange;
	}
	...
	public String getApEndReTypeName() {
		return apEndReTypeName;
	}

	public void setApEndReTypeName(String apEndReTypeName) {
		this.apEndReTypeName = apEndReTypeName;
	}

	public String getApEndReAmountRangeName() {
		return apEndReAmountRangeName;
	}

	public void setApEndReAmountRangeName(String apEndReAmountRangeName) {
		this.apEndReAmountRangeName = apEndReAmountRangeName;
	}
	...
	public List<ApEndReLineLld> getApEndReLineLldList() {
		return apEndReLineLldList;
	}

	public void setApEndReLineLldList(List<ApEndReLineLld> apEndReLineLldList) {
		this.apEndReLineLldList = apEndReLineLldList;
	}

	public List<ApEndReLineAst> getApEndReLineAstList() {
		return apEndReLineAstList;
	}

	public void setApEndReLineAstList(List<ApEndReLineAst> apEndReLineAstList) {
		this.apEndReLineAstList = apEndReLineAstList;
	}

	public List<ApEndReLineLic> getApEndReLineLicList() {
		return apEndReLineLicList;
	}

	public void setApEndReLineLicList(List<ApEndReLineLic> apEndReLineLicList) {
		this.apEndReLineLicList = apEndReLineLicList;
	}

	public List<ApEndReLineAtt> getApEndReLineAttList() {
		return apEndReLineAttList;
	}

	public void setApEndReLineAttList(List<ApEndReLineAtt> apEndReLineAttList) {
		this.apEndReLineAttList = apEndReLineAttList;
	}
	...
	public List<ApEndReLineLld> getApEndReLineOtherLldList() {
		return apEndReLineOtherLldList;
	}

	public void setApEndReLineOtherLldList(
			List<ApEndReLineLld> apEndReLineOtherLldList) {
		this.apEndReLineOtherLldList = apEndReLineOtherLldList;
	}

...
public class ApEndReSR extends ApEndRe {
	...
	private String apEndReLineType; // 物件申請区分 1:返却、2：再レンタル、3:買取　汎用マスタ-AP_END_LE_LINE_TYPE
	private String apEndReLineTypeName; // 物件申請区分名
	private String astNameLld; // 物件情報(代表)_物件名
	private Date endDate; // 物件情報(代表)_レンタル満了日

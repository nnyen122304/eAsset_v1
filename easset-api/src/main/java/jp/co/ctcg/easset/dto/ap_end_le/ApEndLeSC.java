...
public class ApEndLeSC extends ApEndLe {
	...
	// 申請内容
	private String apEndLeTypePlural; // 申請区分複数
	private Date returnDateFrom; // 返却予定日From
	private Date returnDateTo; // 返却予定日To
	private Long totalAmountFrom; // 残リース料/再リース金額From
	private Long totalAmountTo; // 残リース料/再リース金額To
	...
	// 契約・経費
	private Date endDateFrom; // リース満了日From
	private Date endDateTo; // リース満了日To
	...
	public void readExternal(ObjectInput input) throws IOException, ClassNotFoundException {
		...
		// 申請内容
		apEndLeTypePlural = (String)input.readObject(); // 申請区分複数
		returnDateFrom = (Date)input.readObject(); // 返却予定日From
		returnDateTo = (Date)input.readObject(); // 返却予定日To
		totalAmountFrom = Function.getExternalLong(input.readObject()); // 残リース料/再リース金額From
		totalAmountTo = Function.getExternalLong(input.readObject()); // 残リース料/再リース金額To
		...
		// 契約・経費
		endDateFrom = (Date)input.readObject(); // リース満了日From
		endDateTo = (Date)input.readObject(); // リース満了日To
	...
	public void writeExternal(ObjectOutput output) throws IOException {
		...
		// 申請内容
		output.writeObject(apEndLeTypePlural); // 申請区分複数
		output.writeObject(returnDateFrom); // 返却予定日From
		output.writeObject(returnDateTo); // 返却予定日To
		output.writeObject(totalAmountFrom); // 残リース料/再リース金額From
		output.writeObject(totalAmountTo); // 残リース料/再リース金額To
		...
		// 契約・経費
		output.writeObject(endDateFrom); // リース満了日From
		output.writeObject(endDateTo); // リース満了日To
	...
	public String getApEndLeTypePlural() {
		return apEndLeTypePlural;
	}

	public void setApEndLeTypePlural(String apEndLeTypePlural) {
		this.apEndLeTypePlural = apEndLeTypePlural;
	}

/*===================================================================
 * ファイル名 : ApGetIntLineOtrCost.java
 * 概要説明   : 取得申請(無形)_その他費用明細
 * バージョン : 1.0
*====================================================================
 * 修正履歴
 * 日付       Ver. 担当者       修正内容
...
@ToString
public class ApGetIntLineOtrCost extends LineData {
	...
	private String otrComment;			// コメント
	private Long otrAmount;				// 金額(税抜)
	...
	public void readExternal(ObjectInput input) throws IOException, ClassNotFoundException {
		...
		otrComment = (String)input.readObject();
		otrAmount = Function.getExternalLong(input.readObject());
	}
	...
	public void writeExternal(ObjectOutput output) throws IOException {
		...
		output.writeObject(otrComment);
		output.writeObject(otrAmount);
	}
	...
	public String getOtrComment() {
		return otrComment;
	}

	public void setOtrComment(String otrComment) {
		this.otrComment = otrComment;
	}

	public Long getOtrAmount() {
		return otrAmount;
	}

	public void setOtrAmount(Long otrAmount) {

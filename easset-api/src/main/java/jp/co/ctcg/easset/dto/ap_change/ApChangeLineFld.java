...
@ToString
public class ApChangeLineFld implements Externalizable {
	private static final long serialVersionUID = 1L;

	private String applicationId; // 申請書番号
	private String apChangeLineFldType; // 資産明細区分 1:有形固定資産,2:無形固定資産
	...
	private Long astBookAmount; // 帳簿価額
	...
	private String holSectionName; // 保有部署名(無形)
	...
	public void readExternal(ObjectInput input) throws IOException, ClassNotFoundException {
		...
		apChangeLineFldType = (String)input.readObject();
	...
	public void writeExternal(ObjectOutput output) throws IOException {
		...
		output.writeObject(apChangeLineFldType);
	...
	/**
	 * @return the apChangeLineFldType
	 */
	public String getApChangeLineFldType() {
		return apChangeLineFldType;
	}

	/**
	 * @param apChangeLineFldType the apChangeLineFldType to set
	 */
	public void setApChangeLineFldType(String apChangeLineFldType) {
		this.apChangeLineFldType = apChangeLineFldType;
	}
	 ...
	 * @return ApChangeLineFld.class 該当クラス
	 */
	public static ApChangeLineFld fromString(String json) {
		return MappingUtils.fromJson(json, ApChangeLineFld.class);
	}
}

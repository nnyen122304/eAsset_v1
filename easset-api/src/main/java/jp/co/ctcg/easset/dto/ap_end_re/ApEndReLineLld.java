...
@ToString
public class ApEndReLineLld extends LineData {
	...
	private String apEndReLineType; // 物件申請区分 1:返却、2：再レンタル、3:買取　汎用マスタ-AP_END_RE_LINE_TYPE
	private String apEndReLineTypeName; // 物件申請区分名
	...
	private Date endDate; // レンタル満了日
	private Long remainAmount; // 残レンタル料
	private Long monthAmount; // 均等額（ﾘｰｽ月額）
	private Long reAmount; // 再レンタル金額
	...
	private String leCompanyCode; // レンタル会社コード
	...
	public void readExternal(ObjectInput input) throws IOException, ClassNotFoundException {
		...
		apEndReLineType = (String)input.readObject();
		apEndReLineTypeName = (String)input.readObject();
	...
	public void writeExternal(ObjectOutput output) throws IOException {
		...
		output.writeObject(apEndReLineType);
		output.writeObject(apEndReLineTypeName);
	...
	public String getApEndReLineType() {
		return apEndReLineType;
	}

	public void setApEndReLineType(String apEndReLineType) {
		this.apEndReLineType = apEndReLineType;
	}
	...
	public String getApEndReLineTypeName() {
		return apEndReLineTypeName;
	}

	public void setApEndReLineTypeName(String apEndReLineTypeName) {
		this.apEndReLineTypeName = apEndReLineTypeName;
	}
